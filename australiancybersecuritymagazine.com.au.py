...
url = "https://australiancybersecuritymagazine.com.au"
output_dir = os.path.join('.', 'data', 'australiancybersecuritymagazine.com.au')
headers = {
        'Accept':'application/json, text/javascript, */*; q=0.01',
        'Accept-Encoding':'*',
        'Accept-Language':'zh-CN,zh;q=0.8',
        'Host': 'australiancybersecuritymagazine.com.au',
